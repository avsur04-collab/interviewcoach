...
# STEP 3: View Feedback
    ...
    with tab2:
        ...
        <div style="background-color: #EFF6FF; border-left: 4px solid #1E40AF; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem;">
            <strong>Powered by Gemini 3 Flash</strong> - Multimodal video analysis
        </div>
        """, unsafe_allow_html=True)
...
{'='*60}
Powered by Gemini 3 Flash + Claude Sonnet 4
"""
...
st.markdown("""
    <div style="text-align: center; color: #6B7280; padding: 2rem 0;">
        <p><strong>Dual-AI Architecture:</strong> Gemini 3 Flash (Video Analysis) + Claude Sonnet 4 (Strategic Coaching)</p>
